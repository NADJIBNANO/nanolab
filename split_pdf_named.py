...
wb = load_workbook('momber_com_scien.xlsx')
sheet = wb['Feuil1']
...
for page_num in range(pdf.numPages):
    ...
    with open(os.path.join(output_folder_path, '{0}{1}.pdf'.format(list_nom[page_num+1], page_num+1)), 'wb') as f:
        pdfWriter.write(f)
        print("The Splite Is Done", list_nom[page_num+1])
        f.close()
